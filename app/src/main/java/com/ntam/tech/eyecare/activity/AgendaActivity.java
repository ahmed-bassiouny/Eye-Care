...
import com.ntam.tech.eyecare.adapter.AgendaDayAdapter;
import com.ntam.tech.eyecare.adapter.SessionAgendaAdapter;
import com.ntam.tech.eyecare.adapter.SessionMyAgendaAdapter;
...
import com.ntam.tech.eyecare.model.Session;
...
public class AgendaActivity extends AppCompatActivity implements OnClickListenerAdapter {
    ...
    private void loadAgenda() {
        showData(false);
        RetrofitRequest.getAllAgenda(SharedPref.getMyAccount(this).getUserId(), new RetrofitResponse<List<com.ntam.tech.eyecare.model.Agenda>>() {
            @Override
